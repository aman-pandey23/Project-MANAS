...
if("TRUE" STREQUAL "TRUE")
  set(motion_plan_SOURCE_PREFIX /home/aman/simulation_ws/src/motion_plan)
  set(motion_plan_DEVEL_PREFIX /home/aman/simulation_ws/devel)
  ...
  set(motion_plan_INSTALL_PREFIX /home/aman/simulation_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_plan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aman/simulation_ws/src/motion_plan/${idir}'.  ${_report}")
    endif()
